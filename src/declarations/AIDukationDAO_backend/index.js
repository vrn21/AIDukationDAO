...
import { idlFactory } from './AIDukationDAO_backend.did.js';
export { idlFactory } from './AIDukationDAO_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.AIDUKATIONDAO_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./AIDukationDAO_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the AIDukationDAO_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./AIDukationDAO_backend.did.js")._SERVICE>}
 */
export const AIDukationDAO_backend = createActor(canisterId);
