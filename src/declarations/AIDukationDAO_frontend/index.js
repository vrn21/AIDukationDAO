...
import { idlFactory } from './AIDukationDAO_frontend.did.js';
export { idlFactory } from './AIDukationDAO_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.AIDUKATIONDAO_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./AIDukationDAO_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the AIDukationDAO_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./AIDukationDAO_frontend.did.js")._SERVICE>}
 */
export const AIDukationDAO_frontend = createActor(canisterId);
